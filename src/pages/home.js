            ...
            <div className="container">
              <div className="inner-wrapper">
                ...
                <div className="bottom-footer clearfix">
                  ...
                  <ul>
                    <li><Link to="https://www.facebook.com/SURTiiTech"><i className="fa fa-facebook" aria-hidden="true"></i></Link></li>
                    <li><Link to="https://twitter.com/ScaleX_Africa"><i className="fa fa-twitter" aria-hidden="true"></i></Link></li>
                    <li><Link to="https://www.instagram.com/p2pbyscale/"><i className="fa fa-instagram" aria-hidden="true"></i></Link></li>
                  </ul>
                </div> 
              </div>
            </div>
